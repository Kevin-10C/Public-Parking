...
public class TicketController {
    ...
    public void add(String firstName, String lastName, String id, String code, String phoneNumber, String gener, String age,
        ...
        persistence1.create();
        persistence1.read(firstName, lastName, id, code, phoneNumber, gener, age,
                mark, licensePlate, color, observation, description, type,
                dateAdmision, departureDate, checkInTime, departueTime);
    }

    public void find(String searchString,String data) {

        persistence2 = new DBManager();
        persistence2.find(searchString,data);
